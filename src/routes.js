...
router.put('/funil/send-data', upload.single('fileData'), async (req, res) => {
    try {
        let { typeMSG, MSGType, positionId, delayType, delayData, stateContinue, funiltRebate, templatetRebate, textareaData, fileType } = req.body
        positionId = parseInt(positionId)
        typeMSG = parseInt(typeMSG)
        //console.log('na rota: ', { typeMSG, MSGType, positionId, delayType, delayData, stateContinue, funiltRebate, templatetRebate, textareaData, fileType })
        const fileData = req.file
        //console.log('arquivo na rota: ', fileData)
        await Send_To_Funil(typeMSG, MSGType, positionId, delayType, delayData, stateContinue, funiltRebate, templatetRebate, textareaData, fileType, fileData)
